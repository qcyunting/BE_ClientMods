...
class NpcDialogMod(ClientSystem):
	def __init__(self, namespace, systemName):
		print("==== NpcDialogMod Init ====")
	...
	def listen_server(self,event,func):
		self.ListenForEvent(modConfig.ModName, "NpcDialogMod", event, self, func)
	...
	def UiInitFinished(self, args):
		# 注册并创建商店ui
		path_h = "NpcDialogModScripts.modClient.ui."
